...
impl NavicoControls {
    pub fn new2(
        ...
        if model == Model::HALO {
            ...
            controls.insert(ControlType::ModelName, Control::new_string(ControlType::ModelName));
            controls.insert(
        ...
        controls.insert(
            ...
            Control::new_list(ControlType::InterferenceRejection, &["Off", "Low", "Medium", "High"])
        );
        controls.insert(ControlType::Rain, Control::new_numeric(ControlType::Rain, 0, 100));
        ...
        controls.insert(
            ...
            Control::new_list(ControlType::ScanSpeed, if model == Model::HALO {
                &["Normal", "Medium", "", "Fast"]
            } else {
                &["Normal", "Fast"]
            })
        ...
        controls.insert(
            ...
            Control::new_list(ControlType::TargetExpansion, if model == Model::HALO {
                &["Off", "Low", "Medium", "High"]
            } else {
                &["Off", "On"]
            })
        ...
        controls.insert(
            ...
            Control::new_list(ControlType::NoiseRejection, if model == Model::HALO {
                &["Off", "Low", "Medium", "High"]
            } else {
                &["Off", "Low", "High"]
            })
        ...
        if model == Model::HALO || model == Model::Gen4 {
            controls.insert(
                ...
                Control::new_list(ControlType::TargetSeparation, &["Off", "Low", "Medium", "High"])
            );
        }
        if model == Model::HALO {
            controls.insert(
        ...
        controls.insert(
            ...
            Control::new_numeric(ControlType::OperatingHours, 0, i32::MAX).read_only().unit("h")
        );

        controls.insert(ControlType::SerialNumber, Control::new_string(ControlType::SerialNumber));
